      ...
      <div className="aboutme_information">
        ...
        <div className="aboutme_skills">
          ...
          <div className="aboutme_content">
            ...
            <div>
            <b>Operating System/Software</b>: Linux, Windows, MacOS, Microsoft Office,
              LTspice, Latex, Git, ROS, React
            </div>
            <div>
            <b>Hardware</b>: Arduino, Raspberry Pi, Nvidia Jetson Tx2, Xilinx Zynq-7000
              development board
            </div>
            <div> <b>Web Development tools</b>: MySQL, JSP, Sass/CSS, Node.js</div>
          </div>
        </div>
      </div>
    </div>
